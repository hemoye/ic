			...
			<div class="row">
				...
				<div id="content" class="col-lg-10 col-md-10">
					...
					<ol class="breadcrumb">
					  ...
					  <li class="active">回复编号为：<s:property value="reply.replyId"/>的详细信息</li>
					</ol>
					<!-- nav breadcrumb end -->		
					<div class="row" style="padding-top: 0;">
						<div class="panel panel-default">
							<div class="panel-heading"><span class="fa fa-list"></span>&nbsp;回复编号为：<s:property value="reply.replyId"/>的详细信息</div>
										...
										<table class="table" style="table-layout:fixed;">
											<tbody>
												<!--
							                    	...
							                    	<td colspan="3">内容</td>
                                                -->
							                     <tr><td width="120" align="right">回复编号：</td><td><s:property value="reply.replyId"/></td></tr>
							                     <tr><td align="right">帖子编号：</td><td><s:property value="reply.userpost.postId"/> </td></tr>
							                     <tr><td align="right">父级回复：</td><td><s:property value="reply.reply.replyId"/></td></tr>
							                     <tr><td align="right">用户编号：</td><td><s:property value="reply.user.userId"/></td></tr>
							                      <tr><td align="right">回复内容：</td><td title="<s:property value="reply.replyContext"/>"  style="width:100%; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><s:property value="reply.replyContext"/> </td></tr>
						                          <tr><td align="right">回复数：</td><td><s:property value="reply.replyNumber"/></td></tr>
						                          <tr><td align="right">回复地址：</td><td> <s:property value="reply.replyUrl"/> </td> </tr>
						                           <tr><td align="right">回复时间：</td><td><s:property value="reply.replyTime"/></td></tr>
						                            <tr><td align="right">状态：</td><td> <s:property value="reply.status?'采纳':'未被采纳'"/> </td></tr>
