...
<html>
	<head>
	    ...
	    <script src="<%=basePath%>backstage/js/filter/filter.js"></script>
		...
		<div class="container" id="main">
			<div class="row">
				...
				<div id="content" class="col-lg-10 col-md-10">
					...
					<ol class="breadcrumb">
					  <li><a href="javascript:void(0)"><span class="fa fa-home"></span>&nbsp;脏话管理</a></li>
					  <li class="active">所有过滤字</li>
					</ol>
					<!-- nav breadcrumb end -->		
					<div class="row" style="padding-top: 0;">
						<div class="panel panel-default">
							<div class="panel-heading"><span class="fa fa-list"></span>&nbsp;过滤字列表</div>
							<div class="panel-body">
								<div class="btn-group form-inline" role="group">
									...
									<input type="button" onclick="openaddModal()" class="button button-small border-green" value="添加过滤字">
									<form action="javascript:searchByfilterName()">
	        ...
	        <form id="_addfatherType" action="javascript:addfatherType()" method="POST" class="form-horizontal">
	          ...
	          <div class="modal-body">
	            <div class="form-group">
	              <div class="col-md-12">
	                <input type="text" name="rootName" class="form-control" id="rootName" placeholder="过滤字名称" >
	              </div>
	            </div>
	            <div class="form-group">
	              <div class="col-md-12">
	              	<input type="text" name="filterDesc" class="form-control" id="filterDesc" placeholder="过滤字替换为" >
	              </div>
	            </div>
	          </div>
