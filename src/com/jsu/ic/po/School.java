...
public class School  implements java.io.Serializable {
	...
	/** minimal constructor */
    public School(String schoolName, Timestamp addTime, Timestamp updateTime) {
    ...
    /** full constructor */
    public School(School school, County county, String schoolName, Integer departNum, Integer stuNum, Timestamp addTime, Timestamp updateTime, Boolean isDelete, Integer sortNumber, Set departs, Set schools) {
        this.school = school;
        this.county = county;
        this.schoolName = schoolName;
