...
public class Applyfriend implements java.io.Serializable {
	...
	/** minimal constructor */
	public Applyfriend(Timestamp addTime, Timestamp updateTime, Boolean isDelete, Integer sortNumber) {
	...
	/** full constructor */
	public Applyfriend(Userinfo userinfoByApplyUserId, Userinfo userinfoByRecUserId, String context, Integer status,
			Timestamp addTime, Timestamp updateTime, Boolean isDelete, Integer sortNumber) {
