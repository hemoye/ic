...
public class Message implements java.io.Serializable {
	...
	/** minimal constructor */
	public Message(String messageContext, Timestamp sendTime, Integer status, Boolean isDelete, Integer sortNumber) {
	...
	/** full constructor */
	public Message(User userByUserIdA, User userByUserIdB, String messageContext, Timestamp sendTime, Integer status,
