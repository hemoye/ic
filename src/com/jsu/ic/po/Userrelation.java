...
public class Userrelation  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Userrelation(Timestamp addTime, Timestamp updateTime) {
        this.addTime = addTime;
        this.updateTime = updateTime;
    }
    
    /** full constructor */
    public Userrelation(Userinfo userinfoByUserIdA, Userinfo userinfoByUserIdB, String userName, Timestamp addTime, Timestamp updateTime, Boolean isDelete, Integer sortNumber) {
